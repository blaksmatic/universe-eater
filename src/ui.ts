...
import { WEAPON_SHAPES } from './ui/icons';
export { WEAPON_SHAPES } from './ui/icons';
...
// Design system re-exports — canonical implementations live in ./ui/theme.ts
export { UI_COLORS, glassPanel, glowText, spacedText, gradientText } from './ui/theme';
